        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    @lang('users.audit.title')

                    <a style="position: absolute; right: 25px; top: 6px;" href="{{route('users.edit', ['id' => $user->id])}}" class="btn btn-sm btn-success">@lang('users.back_to_user')</a>
                </div>
