            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @forelse ($machines as $machineObj)
                            <tr>
                                <td class='text-left'>

                                    @if ($active)
                                    <a href='{{route('recipes.index', ['concept' => $concept, 'machine' => $machineObj->machine])}}' class=''>{{ $machineObj->machine }}</a>
                                    @else
                                    <a href='{{route('recipes.index_not_active', ['concept' => $concept, 'machine' => $machineObj->machine])}}' class=''>{{ $machineObj->machine }}</a>
                                    @endif
                                </td>
                            </tr>
                            @empty
